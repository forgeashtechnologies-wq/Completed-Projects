...
$error_path = $root_path . '/error.php';
...
if (file_put_contents($error_path, $error_content)) {
    echo "error.php created successfully!";
} else {
    echo "Failed to create error.php";
}
?> 